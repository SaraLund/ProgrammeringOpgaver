    ...
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Song != null ? 
                          ...
                          Problem("Entity set 'MusicStoreContext.Song'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("SongId,Title,ReleaseDate")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SongId,Title,ReleaseDate")] Song song)
        {
            if (id != song.SongId)
            {
                return NotFound();
