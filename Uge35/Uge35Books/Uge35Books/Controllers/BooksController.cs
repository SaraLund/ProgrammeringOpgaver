...
namespace Uge35Books.Controllers
{
    public class BooksController : Controller
    {
        private readonly Uge35BooksContext _context;

        public BooksController(Uge35BooksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Book != null ? 
                          ...
                          Problem("Entity set 'Uge35BooksContext.Book'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Uge35BooksContext.Book'  is null.");
            }
            var book = await _context.Book.FindAsync(id);
            if (book != null)
            {
